  ...
  return (
    <div className={Styles['container-foro']} >
      ...
      <div className={Styles.divContainer} >
         <Link to='/foro/primer-foro-social' ><h2 className={Styles.titleF} >
        REALIZACIÓN DEL PRIMER FORO SOCIAL Y AMBIENTAL “NATURALEZA SOMOS”:
      </h2></Link>
    <div className={Styles['texto-foro']}>
      <img src={imageSomos} alt="cabecera" className={`${Styles.imageForum} ${Styles.right}`} />
      <p  >
      ...
      <h3 className={Styles.titleTwo} >Conflictos y Litigios socioambientales</h3>
